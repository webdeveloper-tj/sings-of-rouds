...
const Navbar = () => {
  ...
  return (
    <div className="bg-white border-blue-200 dark:bg-blue-900 mx-auto">
      <div className=" flex flex-wrap items-center justify-between mx-auto p-4 bg">
        ...
        >
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-blue-100 rounded-lg bg-blue-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-blue-800 md:dark:bg-blue-900 dark:border-blue-700">
            <li>
              <NavLink
                to={"/"}
                className="block py-2 px-3 text-blue-900 rounded hover:bg-blue-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-blue-700 dark:hover:text-white md:dark:hover:bg-transparent"
                aria-current="page"
              >
                Асосӣ
              </NavLink>
